...
function AddPlanq() {
    ...
    return (
        <button className="bg-gray-800 hover:bg-cyan-400 text-cyan-400 hover:text-white font-semibold py-2 px-4 border  rounded shadow" onClick={handleClick}>✚ | Planq Network </button>
      );
  }
